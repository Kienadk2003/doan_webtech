        ...
        <ul class="navbar-nav d-flex align-items-center navbar-light ms-auto">
            ...
            <li class="dropdown">
                <a href="#" data-bs-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                    ...
                    <!-- <div class="d-none d-md-block d-lg-inline-block">{{Auth::guard('admin')->user()->firstname}}</div> -->
                </a>
                <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="/admin/profile"><i data-feather="user"></i>{{__("Account")}}</a>
                    <a class="dropdown-item" href="#"><i data-feather="mail"></i>{{__("Messages")}}</a>
