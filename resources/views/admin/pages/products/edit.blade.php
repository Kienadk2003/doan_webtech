...
<div class="container-fluid py-4">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form method="post" action="/admin/accessories/edit/{{$products->id}}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                                    ...
                                    <div class="form-group file-uploader-library">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div>
                                                    <a href="javascript:void(0)" data-url="{{ url('admin/accessories/deleteimages', $img->id ) }}" class="btn text-danger delete-image">X</a> 
