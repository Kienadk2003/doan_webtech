                    ...
                    <div class="card-body">
                        <form action="/imageProfile" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <img src="https://res.cloudinary.com/{{env('CLOUD_NAME')}}/image/upload/{{$user->image}}.jpg"
                                    class="rounded-circle p-1 bg-primary mb-2" height="100" width="100">
                                @else
                                <img src="images/avatar/avatar.png" class="rounded-circle p-1 " width="110">
                                @endif
                                @endif
                                ...
                                <div class="mt-3">
                                    ...
                                    <button type="submit"
                                        class="btn btn-outline-primary">{{__("Update Image")}}</button>
                                </div>
                            </div>
                        </form>
                        <hr class="my-4">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <div class="position-relative">
                                        <input type="password" name="password" id="password"
                                            class="password form-control" disabled>
                                        <i class="fa fa-eye position-absolute" id="togglePassword"
                                            style="top: 50%; right: 15px; transform: translateY(-50%); cursor: pointer; display: none;"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                    <h6 class="mb-0">{{__("Password again")}}</h6>
                                </div>
                                <div class="col-sm-9 text-secondary">
                                    <div class="position-relative">
                                        <input type="password" name="repassword" id="repassword"
                                            class="password form-control" disabled>
                                        <i class="fa fa-eye position-absolute" id="toggleRePassword"
                                            style="top: 50%; right: 15px; transform: translateY(-50%); cursor: pointer; display: none;"></i>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    $('.checkPassword').change(function() {
        if ($(this).is(":checked")) {
            ...
            $('#togglePassword, #toggleRePassword').show();
        } else {
            $('.password').attr('disabled', '');
            $('#togglePassword, #toggleRePassword').hide();
        }
    });
...
$('#profile_form').on('submit', function(e) {
    ...
    $.ajax({
        ...
        error: function(xhr) {
            var msg = 'Cập nhật không thành công. Vui lòng kiểm tra lại thông tin.';
