...
<div class="col-6 col-md-4 col-xl-3 isotope-item sale">
    <div class="grid_item">
        <figure>
            ...
            <a href="/accessory/{{$pro->id}}">
                ...
                <img style="width:270px; height:250px" class="img-fluid lazy"
                    data-src="https://res.cloudinary.com/{{env('CLOUD_NAME')}}/image/upload/{{$img->image}}.jpg" alt="">
                @else
        ...
        <ul>
            <li>
                @if(Auth::check())
                <?php $count = $wishlist->countWishlist($pro->id); ?>
            ...
            <li>
                <form action="/cart" method="post" id="formSubmitCart_{{$pro->id}}">
                    ...
                    <a href="javascript:void(0)"
                        onclick="document.getElementById('formSubmitCart_{{$pro->id}}').submit();" class="tooltip-1"
                        data-bs-toggle="tooltip" data-bs-placement="left" title="{{__('Add to cart')}}"><i
