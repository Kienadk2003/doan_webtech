<div class="container margin_60_35">
    <div class="main_title">
        <a href="#">
            <h2>{{__("Featured Accessories")}}</h2>
            <span>{{__("Featured Accessories")}}</span>
        </a>
        <!-- <p>Cum doctus civibus efficiantur in imperdiet deterruisset</p> -->
    </div>
    <div class="owl-carousel owl-theme products_carousel">
        @foreach($products_featured->shuffle() as $pro)
        ...
        <div class="item">
            <div class="grid_item">
                ...
                <a href="/accessory/{{$pro->id}}">
                    <h3 class="d-block"
                        style="max-width: 270px; height:50px; overflow: hidden;text-overflow: ellipsis;white-space: nowrap; margin: 0 auto">
                        {{$pro->name}}</h3>
                </a>
                <div class="price_box">
