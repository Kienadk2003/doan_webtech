<div class="container">
    <div class="main_title mb-4">
        <a href="/accessories">
            <h2>{{__("New Accessories")}}</h2>
            <span>{{__("New Accessories")}}</span>
        </a>
        ...
        <div class="row small-gutters">
            ...
            <div class="col-6 col-md-4 col-xl-3 isotope-item popular" style="max-height:440px">
                <div class="grid_item">
                    ...
                    <a href="/accessory/{{$new->id}}">
                        <h3 class="d-block">{{$new->name}}</h3>
                    </a>
                    <div class="price_box ">
                        @if($new->price_new !=0 && $new->price !=0)
                        <span class="new_price">{{number_format($new->price_new,0,",",".")}} VND</span>
                        <span class="old_price">{{number_format($new->price,0,",",".")}} VND</span>

                        @elseif($new->price_new == 0 && $new->price !=0)
                        <span class="new_price">{{number_format($new->price,0,",",".")}} VND</span>
                    ...
                    <ul>
                        <li>
                            ...
                            <?php 
													...
													?>
                            <a href="javascript:void(0)" data-productid="{{$new->id}}" class="tooltip-1 wishlist"
                            ...
                            @else
                            <a href="/signin_signup" data-productid="{{$new->id}}" class="tooltip-1 wishlist"
                                data-bs-toggle="tooltip" data-bs-placement="left" title="{{__('Add to favorites')}}">
                                <i class="fa-regular fa-heart"></i>
                                <span>{{__('Add to favorites')}}</span>
                            </a>
                        ...
                        <li>
                            <form action="/cart" method="post" id="formSubmitCart_{{$new->id}}">
                                ...
                                <a href="javascript:void(0)"
                                    onclick="document.getElementById('formSubmitCart_{{$new->id}}').submit();"
