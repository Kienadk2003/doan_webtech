                ...
                <div class="all">
                    <div class="slider">
                        <div class="owl-carousel owl-theme main">
                            ...
                            <div style="background-image: url(https://res.cloudinary.com/{{env('CLOUD_NAME')}}/image/upload/{{$img->image}}.jpg);"
                                class="item-box"></div>
                            @else
            ...
            <div class="col-md-6">
                ...
                <form action="/cart" method="post">
                    ...
                    <div class="prod_info">
                        ...
                        <p><small>{{$products->categories->name}}:
                                {{$products->subcategories->name}}-{{$products->id}}</small>
                        ...
                        <div class="prod_options">
                            <div class="row">
                                <label
                                    class="col-xl-5 col-lg-5  col-md-6 col-6"><strong>{{__("Quantity")}}</strong></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="btn_add_to_cart"><button type="submit"
                                        class="btn_1">{{__("Add to Cart")}}</button></div>
                            </div>
                ...
                <div class="row">
                    <div class="product_actions">
                        <ul>
                            <li>
								...
								?>
                                <a href="javascript:void(0)" data-productid="{{$products->id}}"
                                    class="tooltip-1 wishlistDetail" data-bs-toggle="tooltip" data-bs-placement="left"
                                ...
                                @else
                                <a href="/signin_signup" data-productid="{{$products->id}}" class="tooltip-1 wishlist"
                    ...
                    <div id="reviews" class="col-lg-5 col-md-6 mt-3">
                        <a href="#Reviews" data-bs-toggle="collapse" data-bs-target="#Reviews" aria-expanded="false"
                        ...
                        <div class="card-body">
                            <div class="row justify-content-center ">
                                ...
                                <iframe style="height: 700px;" width="100%"
                                    src="https://www.youtube.com/embed/{{$products->youtube_path}} "
        ...
        <div class="owl-carousel owl-theme products_carousel">
            ...
            <div class="item">
                <div class="grid_item">
                    ...
                    @endif
                    <figure>
                        <a href="/accessory/{{$re->id}}">
                            @if(strstr($img->image,"https") == "")
                            <img class="img-fluid lazy" style="width:290px; height: 290px;"
                                data-src="https://res.cloudinary.com/{{env('CLOUD_NAME')}}/image/upload/{{$img->image}}.jpg"
                                alt="">
                            @else
                            <img class="img-fluid lazy" style="width:290px; height: 290px;" data-src="{{$img->image}}"
                                alt="">
                            @endif
                        </a>
                    </figure>
                    ...
                    <a href="product-detail-1.html">
                        <h3 class="d-block">{{$re->name}}</h3>
                    </a>
                    <div class="price_box">
                        @if($re->price_new!=0 && $re->price!=0)
                        <span class="new_price">{{number_format($re->price_new,0,",",".")}} VND</span>
                        <span class="old_price">{{number_format($re->price,0,",",".")}} VND</span>

                        @elseif($re->price_new==0 && $re->price!=0)
                        <span class="new_price">{{number_format($re->price,0,",",".")}} VND</span>
                    ...
                    <ul>
                        <li>
							...
							?>
                            <a href="javascript:void(0)" data-productid="{{$re->id}}" class="tooltip-1 wishlist"
                            ...
                            @else
                            <a href="/signin_signup" data-productid="{{$re->id}}" class="tooltip-1 wishlist"
                                data-bs-toggle="tooltip" data-bs-placement="left" title="{{__('Add to favorites')}}">
                                <i class="fa-regular fa-heart"></i>
                                <span>{{__('Add to favorites')}}</span>
                            </a>
                        ...
                        <li>
                            <form action="/cart" method="post" id="formSubmitCart_{{$re->id}}">
                                ...
                                <a href="javascript:void(0)"
                                    onclick="document.getElementById('formSubmitCart_{{$re->id}}').submit();"
        ...
        success: function(data) {
            if (data.action == 'add') {
                ...
                $('a[data-productid=' + product_id + ']').html(
                    '<i class="fa-solid fa-heart" style="color:red"></i>').append(
                    `<span>{{__('Add to favorites')}}</span>`);
            } else if (data.action == 'delete') {
                totalWishlist();
                $('a[data-productid=' + product_id + ']').html(
                    '<i class="fa-regular fa-heart"></i>').append(
                    `<span>{{__('Add to favorites')}}</span>`);
