    ...
    <div class="container">
        <div class="breadcrumbs">
            <ul>
                ...
                <li><a href="/list">{{__("Accessories")}}</a></li>
                @if(isset($subcategory) && $subcategory->categories)
                <li><a href="/category/{{$subcategory->categories->id}}">{{$subcategory->categories->name}}</a></li>
                @endif
                <li>{{ isset($subcategory) ? $subcategory->name : __("Subcategories") }}</li>
            </ul>
        </div>
    </div>
    <!-- /top_banner -->
