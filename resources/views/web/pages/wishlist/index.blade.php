    ...
    <div class="container margin_30">
        <div class="row small-gutters">
            ...
            <div class="col-6 col-md-4 col-xl-3">
                <div class="grid_item">
                    @if(isset($pro->products->price_new) && isset($pro->products->price) && $pro->products->price != 0
                    && $pro->products->price_new != 0)
                    <span
                        class="ribbon off">-{{round((($pro->products->price - $pro->products->price_new)/$pro->products->price)*100,0) }}
                        %</span>
                    ...
                    @endif
                    <figure>
                        <a href="/accessory/{{$pro->products->id}}">
                            ...
                            <img style="width:290px; height: 290px;" class="img-fluid lazy"
                                ...
                                alt="">
                            @else
                            <img style="width:290px; height: 290px;" class="img-fluid lazy" data-src="{{$img->image}}"
                                alt="">
                            @endif
                        </a>
                    ...
                    <a href="/accessory/{{$pro->products->id}}">
                        <h3 class="d-block">{{$pro->products->name}}</h3>
                    </a>
                    <div class="price_box">
                        @if($pro->products->price != 0 && $pro->products->price_new != 0)
                        <span class="new_price">{{number_format($pro->products->price_new,0,",",".")}} VND</span>
                        <span class="old_price">{{number_format($pro->products->price,0,",",".")}} VND</span>

                        @elseif($pro->products->price_new==0 && $pro->products->price!=0)
                        <span class="new_price">{{number_format($pro->products->price,0,",",".")}} VND</span>
                    ...
                    <ul>
                        <li>
                            ...
                            <?php
										...
										?>
                            <a href="javascript:void(0)" data-productid="{{$pro->products->id}}"
                                class="tooltip-1 wishlist" data-bs-toggle="tooltip" data-bs-placement="left"
                            ...
                            @else
                            <a href="/signin_signup" data-productid="{{$pro->products->id}}" class="tooltip-1 wishlist"
                        ...
                        <li>
                            <form action="/cart" method="post" id="formSubmitCart_{{$pro->products->id}}">
                                ...
                                <a href="javascript:void(0)"
                                    onclick="document.getElementById('formSubmitCart_{{$pro->products->id}}').submit();"
