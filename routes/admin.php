...
Route::prefix('admin')->middleware('admin', 'role:admin|staff,admin')->group(function () {
    ...
    Route::prefix('products')->group(function () {
        ...
        // Filter sold quantities (AJAX)
        Route::get('/filter-sold', [ProductsController::class, 'filterSold']);
        // Debug route for checking aggregation
        Route::get('/debug-filter', [ProductsController::class, 'debugFilter']);
    });

    // Accessories alias routes (canonical for the project domain language)
    ...
    Route::prefix('orders')->group(function () {
        ...
        Route::get('/filter', [OrdersController::class, 'filterByDate']);
