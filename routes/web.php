...
Route::middleware('language')->group(function(){
            Route::get('/order/confirm/{id}', [WebController::class, 'orderConfirm'])->name('order.confirm');
        Route::post('/checkout_cod',[WebController::class, 'checkout_cod']);
    require 'admin.php';
    ...
    // Accessories (new canonical URLs)
    Route::get('/accessories',[WebController::class, 'list'])->name('accessories.list');
    Route::get('/accessory/{id}',[WebController::class, 'detail'])->name('accessories.detail');
    // Backward-compatible old URLs
    Route::get('/list', function () {
        return redirect()->route('accessories.list');
    });
    Route::get('/detail/{id}', function ($id) {
        return redirect()->route('accessories.detail', ['id' => $id]);
    });
    ...
    // AJAX endpoint for top-selling by month
    Route::get('/top-selling/ajax',[WebController::class, 'topSellingAjax']);
